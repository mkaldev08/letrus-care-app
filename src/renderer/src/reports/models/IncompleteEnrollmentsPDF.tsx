...
interface IncompleteEnrollmentsPDFProps {
  data: EnrollmentResponse
  center: ICenter
  user: IAuth
}

export const IncompleteEnrollmentsPDF: React.FC<IncompleteEnrollmentsPDFProps> = ({
  center,
  data,
  user
}) => {
    ...
    <Document>
      <Page size={'A4'} orientation="portrait" style={{ padding: '25mm 30mm' }}>
        <View style={styles.header}>
          ...
          <Text style={styles.titleDocument}>Relação de Inscrições Não Concluídas</Text>
